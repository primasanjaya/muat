...
TAGS = [
    {
        ...
        'spe': 'CSC epitkane GPU', 'hardware': 'node a6, Tesla P100-PCIE-16GB, driver 530.30.02',
    ...
    },
    {
        ...
        'spe': 'CSC Puhti GPU',
        'hardware': 'node a6, Tesla P100-PCIE-16GB, driver 530.30.02',
        'install': 'bioconda dependency stack + muat 0.1.21 (pip, tagged source)',
        'muat_version': '0.1.21', 'torch': '',
        'results_glob': None,
        'determinism': '',
        'status': 'TO RUN - run_reproduce_d1_bioconda_x10.sbatch (array 1-10%1, a6)',
        'state': 'todo',
    },
    {
        'tag': 'd2',
        ...
        'install': 'docker image v0.1.21, executed by singularity',
        'muat_version': '0.1.21', 'torch': '',
        'results_glob': None,
        'determinism': '',
        'status': 'TO RUN - run_reproduce_d2_x10.sbatch (array 1-10, a1), concurrent with d1',
        'state': 'todo',
    },
    {
        'tag': 'd3',
...
NOTES = [
    ...
    '6. d1 and d2 use the SAME muat version (0.1.21), one installed via bioconda and one via the '
