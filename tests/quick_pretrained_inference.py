...
if __name__ == "__main__":
    ...
    #nora_ckpt = 'Users/primasan/Documents/work/muat-train/bestckpt/wes/smalldemo/myexperiment_MuAtMotifPositionGESF_fo1_bs300_nl1_nh1_ne128_ba2/weight.pthx'

    new_checkpoint = muat_dir + '/data/ckpt/2class/best_ckpt.pthx'
